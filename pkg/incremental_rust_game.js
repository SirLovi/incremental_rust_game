...
export class Game {
    ...
    static build(name) {
        ...
        const ret = wasm.game_build(ptr0, len0);
        return ret !== 0;
    }
    /**
    ...
    static get_resource(name) {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.game_get_resource(ptr0, len0);
        return ret;
    }
    /**
     ...
     * @returns {string}
     */
    static building_cost(name) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.game_building_cost(ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
    ...
    static load(data) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.game_load(ptr0, len0);
    }
    /**
     * Change tick rate in seconds
     * @param {number} rate
     */
    static set_tick_rate(rate) {
        wasm.game_set_tick_rate(rate);
    }
    /**
    ...
    static achievements() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.game_achievements();
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @returns {boolean}
     */
    static research(name) {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.game_research(ptr0, len0);
        return ret !== 0;
    }
    /**
     ...
     * @returns {number}
     */
    static prestige_points() {
        const ret = wasm.game_prestige_points();
        return ret >>> 0;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('incremental_rust_game_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
